...
public class CubeSatController {
    ...
    @Operation(summary = "Retrieve ALL CubeSat records within a specified time range for the authenticated user")
    @GetMapping("/records")
    public List<CubeSatRecord> getRecordsBetweenDates(
        ...
        return cubeSatService.getRecordsBetweenDatesForCubeSat(user.getCubeSat(), start, end);
    }
}
